...
echo -e "  Auther : ${green}IBNU TUNNELING ® ${NC}${YELLOW}(${NC} ${green} IBNU STORE ${NC}${YELLOW})${NC}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Ibnuganteng37/v3/main/"
...
TIMES="10"
CHATID="6947016720"
KEY="7947070199:AAG4iybn8-tiEOecS3XhfxsxkOMdOKbdqYo"
